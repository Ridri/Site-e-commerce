				...
				<div className="flex flex-shrink-0 items-center">
					<div className="flex space-x-4">
						...
						<a href="https://www.konbini.com/">
							<img
								className="logo-konbini"
								src="https://i.pinimg.com/1200x/96/9f/51/969f511943511e2a4cb039767fbe35cd.jpg" alt="logo-kon" width={50} height={40}
							/>
						</a>

						<div className="flex space-x-20">
							<a href="https://www.jacquemus.com/">
								<img className="logo-jacquemus" src="https://i.pinimg.com/736x/03/99/10/039910aa8a700233f1601e8d161b8ead.jpg" alt="logo-jac" width={80} height={40} />
							</a>
								...
								{navigation.map((item) => (
									<a
										...
										className={classNames(
											item.current ? 'color-nav-hover bg-black-900 text-white' : 'color-nav hover:bg-black-700 hover:text-black',
